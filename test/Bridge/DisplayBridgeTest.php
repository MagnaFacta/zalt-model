...
class DisplayBridgeTest extends TestCase
{
    ...
    {
        return [
            [['field' => 2345.123], 2, 'en', '2,345.12'],
            [['field' => 2345.123], 2, 'nl', '2.345,12'],
            [['field' => 2345.123], 2, 'fr', '2' . chr(160)  . '345,12'],
            [['field' => 2345.123], 3, 'en', '2,345.123'],
            [['field' => 2345.126], 2, 'en', '2,345.13'],
            [['field' => 2345.123], 1, 'en', '2,345.1'],
            [['field' => 2345.173], 1, 'en', '2,345.2'],
            [['field' => 2345.123], 4, 'nl', '2.345,1230'],
            [['field' => null], 4, 'nl', null],
            [['field' => 2345], 2, 'en', '2,345.00'],
            [['field' => 0], 2, 'en', '0.00'],
            [['field' => 0], 3, 'en', '0.000'],
            [['field' => 0.000], 2, 'en', '0.00'],
            ];
    }
    ...
    public static function provideNumberFormat(): array
    {
        return [
            ...
            [['field' => 0], 3, 'en', '0.000'],
            [['field' => 0.000], 2, 'en', '0.00'],
            [['field' => 2345.123], "%01.2f", 'en', '2345.12'],
            [['field' => 2345.123], "%01.3f", 'en', '2345.123'],
            [['field' => 2345.123], "%01.2f", 'nl', '2345,12'],
            [['field' => 2345.123], "%0.1f", 'de', '2345,1'],
            [['field' => 0.123], "%0.1f", 'de', '0,1'],
            [['field' => 0.163], "%0.1f", 'it', '0,2'],
            [['field' => null], "%01.2f", 'nl', null],
            [['field' => 23], [__CLASS__, 'alwaysOne'], 'en', 'one'],
            [['field' => null], [__CLASS__, 'alwaysOne'], 'en', 'one'],
            ];
    }
